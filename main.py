...
nombre_E = Entry(window, textvariable=var_nombre, width=60, background="silver")
nombre_E.grid(column=1, row=1, sticky=W)

apellido_E = Entry(window, textvariable=var_apellido, width=60, background="silver")
apellido_E.grid(column=1, row=2, sticky=W)

dni_E = Entry(window, textvariable=var_dni, width=60, background="silver")
dni_E.grid(column=1, row=3, sticky=W)

faltas_E = Entry(window, textvariable=var_faltas, width=60, background="silver")
faltas_E.grid(column=1, row=4, sticky=W)

justificadas_E = Entry(window, textvariable=var_justificadas, width=60, background="silver")
